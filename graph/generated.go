...
type ComplexityRoot struct {
	Mutation struct {
		...
		SignupUser           func(childComplexity int, email string, password string, name string) int
		UpdateUser           func(childComplexity int, id string, email string, password string, name string) int
	}
...
type MutationResolver interface {
	SignupUser(ctx context.Context, email string, password string, name string) (*model.User, error)
	LoginUser(ctx context.Context, email string, password string) (*model.User, error)
	UpdateUser(ctx context.Context, id string, email string, password string, name string) (*model.User, error)
	DeleteUser(ctx context.Context, id string) (*model.User, error)
	RequestPasswordReset(ctx context.Context, email string) (*model.User, error)
	ResetPassword(ctx context.Context, token *string, password string) (*model.User, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.SignupUser":
		...
		return e.complexity.Mutation.SignupUser(childComplexity, args["email"].(string), args["password"].(string), args["name"].(string)), true
	...
	case "Mutation.UpdateUser":
		...
		return e.complexity.Mutation.UpdateUser(childComplexity, args["id"].(string), args["email"].(string), args["password"].(string), args["name"].(string)), true
...
func (ec *executionContext) _Mutation_SignupUser(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().SignupUser(rctx, fc.Args["email"].(string), fc.Args["password"].(string), fc.Args["name"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNUser2ᚖlms_backendᚋgraphᚋmodelᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_UpdateUser(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateUser(rctx, fc.Args["id"].(string), fc.Args["email"].(string), fc.Args["password"].(string), fc.Args["name"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_Users(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.User)
	fc.Result = res
	return ec.marshalNUser2ᚕᚖlms_backendᚋgraphᚋmodelᚐUserᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNUser2lms_backendᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v model.User) graphql.Marshaler {
	return ec._User(ctx, sel, &v)
}

func (ec *executionContext) marshalNUser2ᚕᚖlms_backendᚋgraphᚋmodelᚐUserᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.User) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNUser2ᚖlms_backendᚋgraphᚋmodelᚐUser(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNUser2ᚖlms_backendᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v *model.User) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
